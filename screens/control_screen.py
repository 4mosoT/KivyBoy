...
class Control (ScreenTmplt):
    def __init__(self, **kwargs):
        ...
        self.slide_1 =PipSlider(range=(0,10), step=0.1, value = 5,size_hint=(0,0), size=(150,20), pos=(70,50))
        self.label_1 =PipLabel(size=(50,100),size_hint=(0,0),pos=(0,0),  text=str(self.slide_1.value))
